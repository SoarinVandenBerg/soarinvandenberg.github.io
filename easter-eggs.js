...
let list = document.getElementById("eggList");
      ...
      listEggs.forEach(egg => {
        ...
        document.getElementById("resetEggs").addEventListener("click",() => {
          ...
          localStorage.removeItem("count01");
          localStorage.removeItem("count02");
          localStorage.removeItem("count03");
          localStorage.removeItem("count04");
          localStorage.removeItem("count05");
          localStorage.removeItem("count06");
          localStorage.removeItem("count07");
          localStorage.removeItem("count08");
          localStorage.removeItem("count09");
